...
2. 2. Pick one statistic from the resulting table and comment on it.
...
This boxplot shows evidence consistent with the linear regression estimat of the DIM, which finds a small positive difference in mean math scores for Catholic students. The median math score for Catholic students is marginally higher, and the interquartile ranges of the two groups largely overlap. 
