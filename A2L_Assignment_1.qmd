...
This works and we checked by visually analyzing the data set. We now have two tables for the treated and control groups: JC_short_TG and JC_short_CG. We invite you to confirm this by seeing the printout in the appendix.
...
is modest. Most individuals cluster near the middle of the distribution in more of a flat line, and there is considerable variation in earnings growth across individuals.
