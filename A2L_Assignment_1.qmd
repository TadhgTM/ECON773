...
program. Given that in this experiment access to the Job Corps was randomized, this reflects a causal effect of access to Job Corps on earnings.
...
effect differs between men and women, indicating that the impact of the treatment is not uniform across genders. Recall from above that the unconditional ATE is $16, which is not equal to the average of the CATEs (at about $20). The unconditional ATE is therefore not simply the average of the two CATEs, but rather a weighted average that reflects the relative proportions of men and women in the sample.
...
most individuals have moderate earnings in both periods (points are concentrated between log earnings of 4 and 6 at assignment and in year 4). There is only a slight upward-right trend, indicating a weak positive relationship between initial and later earnings. This suggests that while higher earnings at assignment are somewhat associated with higher earnings in year 4, starting at a higher earnings level does not necessarily translate into systematically higher earnings four years later, and that there is variation in earnings growth across individuals.
...
is modest. Most individuals cluster near the middle of the distribution in more of a flat line, and there is considerable variation in earnings growth across individuals. Given there is dispersion,  unobserved factors likely matter.
...
The control group’s line (denoted in orange) is relatively flat, suggesting that initial average earnings have little effect on year-4 earnings for those who did not recieve access to the Job Corps. In contrast, the treated group’s line (denoted in blue) is a slightly steeper upward sloping line, indicating that higher initial average earnings are associated with higher year-4 earnings, and that the treatment amplifies earnings growth. Overall, this suggests that access to the Job Corps may strengthen the relationship between baseline earnings and later earnings, indicating heterogeneous effects where individuals with higher initial earnings appear to benefit more from the program.
